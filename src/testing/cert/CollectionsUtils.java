...
public class CollectionsUtils {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, String> unsortedMap = new HashMap<>(2) {
            {
                put(1, "f");
                put(2, "e");
                put(3, "d");
        ...
        List<String> sortedList = unsortedMap.values().stream().sorted().peek(v -> System.out.println("Values: " + v)).collect(Collectors.toList());
        sortedList.subList(0,4).stream().forEach(s -> {
            unsortedMap.forEach((key, value) -> {
                if(s.equals(value)) {
                    System.out.println("Keys of unsortedMap: " + key);
                }
            });
        });

        unsortedMap.forEach((key, value) -> {
            System.out.println("Hash of elements of unsortedMap: " + value + " is " + value.hashCode());
        });
